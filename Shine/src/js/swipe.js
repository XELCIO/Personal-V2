const postActionsControllers = document.querySelectorAll(
  ...
  function redirectToGallery() {
    window.location.href = "/Shine/gallery.html";
  }
  
  function redirectToFlower() {
    window.location.href = "/Shine/flower.html";
  } 
  
  function redirectToAnimation() {
    window.location.href = "/Shine/animation.html";
  }
  
  function redirectToSliders() {
    window.location.href = "/Shine/sliders/index.html";
  }
  
  function redirectToMusic() {
    window.location.href = "/Shine/music.html";
  }
